...
function printTreeWithBranches(node, prefix = '', isLast = true) {
  ...
  node.children.forEach((child, index) => {
    ...
    printTreeWithBranches(child, newPrefix, isLastChild);
  });
}

console.log('—— Árvore com Galhos ——');
printTreeWithBranches(tree.root);
